...
export default function MyJourneyPage() {
  ...
  const dismissIntro = useCallback(() => {
    // Persist "seen" the moment the intro is dismissed (not only after the whole
    // tour finishes in dismissTour). If a user leaves mid-story, the flag would
    // otherwise never be set and the opaque full-screen story would replay on
    // every visit, silently intercepting taps on the home CTAs behind it.
